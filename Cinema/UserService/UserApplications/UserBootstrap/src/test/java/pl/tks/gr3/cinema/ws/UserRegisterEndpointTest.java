...
public class UserRegisterEndpointTest {
    ...
    public void userRegisterEndpointRegisterClientWithLoginAlreadyTakenTestNegative() {
        ...
        when(registerUser.registerClient(login, password)).thenThrow(AuthenticationServiceUserWithGivenLoginExistsException.class);
    ...
    public void userRegisterEndpointRegisterStaffWithLoginAlreadyTakenTestNegative() {
        ...
        when(registerUser.registerStaff(login, password)).thenThrow(AuthenticationServiceUserWithGivenLoginExistsException.class);
    ...
    public void userRegisterEndpointRegisterAdminWithLoginAlreadyTakenTestNegative() {
        ...
        when(registerUser.registerAdmin(login, password)).thenThrow(AuthenticationServiceUserWithGivenLoginExistsException.class);
