package pl.tks.gr3.cinema.adapters.messages.repositories;
...
public class MongoRepositoryMessages {
    ...
    public static final String CLIENT_DOC_NOT_FOUND_FOR_TICKET_DOC = "Client object for given ticket document could not be found in the database.";
    public static final String MOVIE_DOC_NOT_FOUND_FOR_TICKET_DOC = "Movie object for given ticket document could not be found in the database.";
