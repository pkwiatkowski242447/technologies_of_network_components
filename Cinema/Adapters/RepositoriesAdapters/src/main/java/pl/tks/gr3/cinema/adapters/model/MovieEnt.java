...
import pl.tks.gr3.cinema.adapters.messages.validation.MovieValidationMessages;
...
public class MovieEnt {
    ...
    @BsonCreator
    public MovieEnt(@BsonProperty(MovieConstants.GENERAL_IDENTIFIER) UUID movieID,
