...
public class AuthenticationControllerTest {
    ...
    public void authenticationControllerRegisterClientWhenLoginIsAlreadyTakenTestNegative() throws Exception {
        ...
        when(registerUser.registerClient(clientNo1.getUserLogin(), clientNo1.getUserPassword())).thenThrow(AuthenticationServiceUserExistsException.class);
    ...
    public void authenticationControllerRegisterStaffWithLoginThatIsAlreadyTakenTestNegative() throws Exception {
        ...
        when(registerUser.registerStaff(staffNo1.getUserLogin(), staffNo1.getUserPassword())).thenThrow(AuthenticationServiceUserExistsException.class);
    ...
    public void authenticationControllerRegisterAdminWithLoginThatIsAlreadyTakenTestNegative() throws Exception {
        ...
        when(registerUser.registerAdmin(adminNo1.getUserLogin(), adminNo1.getUserPassword())).thenThrow(AuthenticationServiceUserExistsException.class);
