...
public class OpenApiConfig {
    ...
    public OpenAPI customOpenAPI() {
        ...
        return new OpenAPI()
                .info(new Info().title("Ticket Service OpenAPI").version("1.0.0").description("Open API documentation for ticket service"))
                .schemaRequirement("Authorization", scheme)
                .servers(List.of(new Server().url("/ticket").description("URL to OpenAPI documentation for ticket service.")))
