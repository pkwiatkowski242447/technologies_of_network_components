...
public class AuthenticationServiceTest {
    ...
    public void authenticationServiceRegisterClientWhoseLoginIsDuplicateTestNegative() {
        ...
        assertThrows(AuthenticationServiceUserExistsException.class, () -> authenticationService.registerClient(clientNo2.getUserLogin(), clientNo2.getUserPassword()));
    ...
    public void authenticationServiceRegisterStaffWhoseLoginIsDuplicateTestNegative() {
        ...
        assertThrows(AuthenticationServiceUserExistsException.class, () -> authenticationService.registerStaff(staffNo2.getUserLogin(), staffNo2.getUserPassword()));
    ...
    public void authenticationServiceRegisterAdminWhoseLoginIsDuplicateTestNegative() {
        ...
        assertThrows(AuthenticationServiceUserExistsException.class, () -> authenticationService.registerAdmin(adminNo2.getUserLogin(), adminNo2.getUserPassword()));
